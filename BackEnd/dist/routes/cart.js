...
router.post("/:id", auth_1.AuthenticateJWTforUser, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (isCourse) {
        ...
        if (userCheck) {
            ...
            if (indexOfCourse == -1) {
                try {
                    const updatedUser = yield db_1.User.findByIdAndUpdate(req.headers["userId"], { $push: { cart: isCourse } }, { new: true });
                    if (updatedUser) {
    ...
    try {
        ...
        if (coursesId.length > 0) {
            const courses = yield Promise.all(coursesId.map((course) => __awaiter(void 0, void 0, void 0, function* () {
                const cartItems = yield db_1.Course.findById(course._id);
                return cartItems;
            })));
