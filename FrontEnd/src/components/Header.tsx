...
import image1 from "../images/header-img1.png"
import image2 from "../images/header-img2.png"
import image3 from "../images/header-img3.png"
import image4 from "../images/header-img4.png"
import image5 from "../images/header-img5.png"
...
function Header(){
    ...
    return(
       ...
       <button className=" bg-gray-800 text-white rounded-full w-10 h-10 flex items-center justify-center text-lg font-bold 
       absolute top-24 md:top-28  left-12 md:left-56 hover:bg-gray-600"
       onClick={handleLeftClick}>
        &lt;</button>
       <img src={images[imageIndex]} alt="header-image1" className='h-[180px] w-1/2 md:h-[260px] flex justify-center items-center'/>
       <button className=" bg-gray-800 text-white rounded-full w-10 h-10 flex items-center justify-center text-lg font-bold 
